...
futsal_knowledge: List[str] = [
    ...
    "4-0フォーメーション（クワトロ）は、守備を重視し全員が守備に専念する形。",
    "3-1フォーメーション（低め）は、3人が守備、1人（ピヴォ）が攻撃起点となる配置。",
    "2-2フォーメーション（ボックス型）は、2人守備＋2人攻撃の距離感で攻守を切り替える配置。",
    "フリーキックやコーナーのセットプレイでは、ショートやダイレクトを使い分ける。",
    "キックインは、ボールがサイドラインを越えた場合に足で再投入する。",
    "スクリーンは、攻撃側が守備者の進路を遮りパスコースを作る。",
    "パワープレーは、GKをフィールド参加させ数的優位で崩す戦術。",
    # ...（あなたの全knowledgeをここに続けてOK）
]
